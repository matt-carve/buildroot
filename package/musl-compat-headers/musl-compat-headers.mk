...
# https://github.com/buildroot/buildroot/blob/2024.11.x/package/musl-compat-headers/musl-compat-headers.mk

MUSL_COMPAT_HEADERS_SOURCE = queue.h
MUSL_COMPAT_HEADERS_SITE = https://raw.githubusercontent.com/NetBSD/src/03be82a6b173b3c62116b7a186067fed3004dd44/sys/sys
...
define MUSL_COMPAT_HEADERS_EXTRACT_CMDS
	$(INSTALL) -m 0644 -D $(DL_DIR)/queue.h $(@D)/queue.h
	$(INSTALL) -m 0644 -D $(PKGDIR)/cdefs.h $(@D)/cdefs.h
endef
