...
# Use gnu-compat names for udp struct members (when using musl)
DHCPDUMP_CFLAGS = -D_GNU_SOURCE

define DHCPDUMP_BUILD_CMDS
	$(MAKE) -C $(@D) CC="$(TARGET_CC) $(TARGET_CFLAGS) $(DHCPDUMP_CFLAGS)" LIBS="$(DHCPDUMP_LIBS)"
endef
